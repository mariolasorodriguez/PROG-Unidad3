...
public class Ejercicio08 {
	public static void main(String[] args) {
		...
		for (posicion = 0; posicion < numeros.length; posicion++) {
			if (numeros[posicion] == numUsuario) {
				System.out.println("El numero " + numUsuario + " se encuentra en la posicion " + posicion);
				encontrado = true;
			} 
		}
		...
		if (!encontrado) {
			System.out.println("El numero " + numUsuario + " no se encuentra en el array.");
		}
